...
<div class="min-h-screen w-full px-4 flex flex-col justify-center items-center text-[#fdfaf5] gap-8">
        ...
        <div class="flex flex-col items-center absolute bottom-10 left-1/2 -translate-x-1/2">
                <p class="text-4xl font-thin italic">WHO'S NEXT?</p>
                <p class="text-2xl font-bold">PERIODE 2026/2027</p>
        </div>
</div>
